...
public final class SmallintValueTraits implements FixLenValueTraits<Short, short[]> {
    ...
    @Override
    public int deserializeArray(ByteBuffer buffer, short[] array)
        ...
        buffer.asShortBuffer().get(array, 0, length); // remember this doesn't advance the original byte buffer's position
