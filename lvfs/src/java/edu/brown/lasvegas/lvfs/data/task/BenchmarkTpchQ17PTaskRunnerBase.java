 ...
 * of TPC-H Q17 Task.
 */
public abstract class BenchmarkTpchQ17PTaskRunnerBase extends DataTaskRunner<BenchmarkTpchQ17TaskParameters> {
    protected static Logger LOG = Logger.getLogger(BenchmarkTpchQ17PTaskRunnerBase.class);
