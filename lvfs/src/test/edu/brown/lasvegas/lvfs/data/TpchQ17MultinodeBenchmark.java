...
public class TpchQ17MultinodeBenchmark {
    ...
    private void setUp (String metadataAddress) throws IOException {
        ...
        lineitemTable = metaRepo.getTable(database.getDatabaseId(), "lineitem");
    }
    ...
    public double exec (String brand, String container) throws Exception {
        ...
        BenchmarkTpchQ17JobController controller = new BenchmarkTpchQ17JobController(metaRepo, 1000L, 100L, 100L);
    ...
    public static void main (String[] args) throws Exception {
        ...
        if (args.length < 3) {
            System.err.println("usage: java " + TpchQ17MultinodeBenchmark.class.getName() + " <metadata repository address> <brand> <container>");
            System.err.println("ex: java " + TpchQ17MultinodeBenchmark.class.getName() + " poseidon:28710 \"Brand#34\" \"MED DRUM\"");
            return;
        }
        ...
        TpchQ17MultinodeBenchmark program = new TpchQ17MultinodeBenchmark();
