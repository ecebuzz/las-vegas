...
public class LVFSFilePathTest {
    ...
    public void testExtract1 () throws Exception {
        LVFSFilePath path = new LVFSFilePath("/lvfs/2/22/30_143/0_111/333_2344.dat");
        assertEquals ("/lvfs/2/22/30_143/0_111/333_2344.dat", path.getAbsolutePath());
        assertEquals ("/lvfs/", path.getLvfsRootDir());
        assertEquals (2, path.getDatabaseId());
        ...
        assertEquals ("/lvfs/2/22/30_143/0_111", path.getParentFolderPath());
    }

    @Test
    public void testExtract2 () throws Exception {
        LVFSFilePath path = new LVFSFilePath("/lvfs/2/22/30_143/1_112/333_4343.dic");
        assertEquals ("/lvfs/2/22/30_143/1_112/333_4343.dic", path.getAbsolutePath());
        assertEquals ("/lvfs/", path.getLvfsRootDir());
        assertEquals (2, path.getDatabaseId());
        assertEquals (22, path.getTableId());
        assertEquals (30, path.getFractureId());
        ...
        assertEquals ("/lvfs/2/22/30_143/1_112", path.getParentFolderPath());
    }

    @Test
    public void testConstruct () throws Exception {
        LVFSFilePath path = new LVFSFilePath("/lvfsrootdir/", 1, 112, 43, 343, 3, 234, 34, 3443, LVFSFileType.POSITION_FILE);
        assertEquals ("/lvfsrootdir/1/112/43_343/3_234/34_3443.pos", path.getAbsolutePath());
        assertEquals ("/lvfsrootdir/", path.getLvfsRootDir());
        assertEquals (1, path.getDatabaseId());
        ...
        assertEquals ("/lvfsrootdir/1/112/43_343/3_234", path.getParentFolderPath());
    }
    ...
    public void testConstructConf () throws Exception {
        for (int i = 0; i < 2; ++i) {
            ...
            LVFSFilePath path = new LVFSFilePath(conf, 1, 112, 43, 343, 3, 234, 34, 3443, LVFSFileType.POSITION_FILE);
            assertEquals ("/assd/1/112/43_343/3_234/34_3443.pos", path.getAbsolutePath());
            ...
            assertEquals (3443, path.getColumnFileId());
            assertEquals (LVFSFileType.POSITION_FILE, path.getType());
            assertEquals ("/assd/1/112/43_343/3_234", path.getParentFolderPath());
        }
    }
}
