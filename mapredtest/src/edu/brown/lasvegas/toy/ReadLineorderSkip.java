...
/**
 * Similar to ReadLineorder, but this uses a sorted input file
 * and skips input to speed it up.
 * The input file is prepared by {@link SortTblFile}. It has
 * a header line at the beginning of each 64MB block.
 * Header line is "#SORT-COL|min_key|max_key|count" eg, "#5|19920101|19920928|674575".
 */
public class ReadLineorderSkip {
    private static Logger LOG = Logger.getLogger(ReadLineorderSkip.class);
    public static class LineReader extends Mapper<Object, Text, Text, LongWritable> {
        private Text label = new Text("sum");
        ...
        public void map(Object key, Text value, Context context)
            ...
            if (lo_orderdate >= 19940210 && lo_orderdate <= 19940216) {
                ...
                if (lo_orderdate > 19940216) {
                    // as the input file is sorted by orderdate, we can stop here.
                    reachedEnd = true;
    ...
    public static void main(String[] args) throws Exception {
        ...
        FileOutputFormat.setOutputPath(job, new Path("hdfs://poseidon.smn.cs.brown.edu:9000/tmp/out_read_lineorder_"
